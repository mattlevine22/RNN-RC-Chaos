...
with open("./Simulation_Data/coupled_lds_data.pickle", "rb") as file:
...
plt.savefig("./Figures_Projection/coupled_lds_Attractor.pdf", dpi=1000, bbox_inches="tight")
plt.close()
...
for proj in [[1,2]]:
    ...
    plt.savefig("./Figures_Projection/coupled_lds_Attractor_2D_"+str(proj[0])+"_"+str(proj[1])+".pdf", dpi=1000, bbox_inches="tight")
    plt.close()
